...
internal fun LocalizedText(
    ...
    val language = currentComposeAppLanguage()
    MaterialText(
        text = localizeAppText(text, language),
        modifier = modifier,
        color = color,
        fontSize = fontSize,
        fontStyle = fontStyle,
...
internal fun localizedContentDescription(text: String): String {
    return localizeAppText(text, currentComposeAppLanguage())
}

@Composable
private fun currentComposeAppLanguage(): AppLanguage {
