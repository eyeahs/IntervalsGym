...
IntervalsGym은 별도의 자체 서버를 운영하지 않습니다. 앱 데이터는 주로 사용자의 Android 기기 안에 저장되며, 사용자가 Intervals.icu 연동을 선택한 경우에만 Intervals.icu 서비스로 운동 Routine 및 운동 기록이 전송될 수 있습니다.
...
2. Android 설정 > 앱 > IntervalsGym > 저장공간에서 앱 데이터를 삭제하면 로컬 운동 Routine, 로컬 운동 기록, 진행 중 운동 상태, Intervals.icu 캐시가 삭제됩니다.
3. IntervalsGym 앱을 제거하면 Android가 앱 저장소에 보관하던 로컬 데이터가 삭제됩니다.

## Intervals.icu에 업로드된 데이터 삭제

사용자가 Intervals.icu 업로드 기능을 사용한 경우, 운동 Routine 또는 운동 결과가 Intervals.icu 계정에 저장될 수 있습니다.
...
- 사용자가 Intervals.icu에 업로드한 운동 Routine 또는 운동 결과
